...
final auditLogsProvider = FutureProvider.family((ref, AuditLogParams params) async {
  final server = ref.read(auditLogsServerProvider);
  return server.call(params);
});

final adminSearchUsersProvider = FutureProvider.family((ref, String query) async {
