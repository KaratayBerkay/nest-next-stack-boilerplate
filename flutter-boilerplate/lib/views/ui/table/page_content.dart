...
class TablePageContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const Text('Basic Table', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          ...
          Card(
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: [
                  _buildRow(colors, 'Alice Johnson', 'alice@example.com', 'Admin', 'Active'),
                  _buildRow(colors, 'Bob Smith', 'bob@example.com', 'Editor', 'Active'),
                  _buildRow(colors, 'Charlie Brown', 'charlie@example.com', 'Viewer', 'Inactive'),
                  _buildRow(colors, 'Diana Prince', 'diana@example.com', 'Editor', 'Active'),
                  _buildRow(colors, 'Eve Wilson', 'eve@example.com', 'Admin', 'Suspended'),
                ],
              ),
            ),
          ),
          const SizedBox(height: 24),
          const Text('With Selection', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          Card(
            child: SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: DataTable(
                columns: const [
                  ...
                  DataColumn(label: Text('Sold', style: TextStyle(fontWeight: FontWeight.w600))),
                ],
  ...
  DataRow _buildRow(AppColors colors, String name, String email, String role, String status) {
    ...
    return DataRow(cells: [
      DataCell(Text(name)),
      DataCell(Text(email, style: TextStyle(color: colors.fgMuted, fontSize: 12))),
      DataCell(Text(role)),
      DataCell(
        Container(
