...
final _uiRoutes = <(String, IconData, String)>[
  ...
  ('Chart', Icons.bar_chart, '/v1/en/ui/chart'),
  ...
  ('Data Table', Icons.table_rows, '/v1/en/ui/data-table'),
  ...
  ('Emoji Picker', Icons.emoji_emotions, '/v1/en/ui/emoji-picker'),
  ...
  ('Page Header', Icons.view_headline, '/v1/en/ui/page-header'),
