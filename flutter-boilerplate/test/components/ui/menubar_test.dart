...
void main() {
  testWidgets('renders menu bar items', (tester) async {
    await pumpTestApp(
      tester,
      MenuBar(items: [
        const MenuBarItem(label: 'File'),
        const MenuBarItem(label: 'Edit'),
      ]),
    );
    ...
    await pumpTestApp(
      ...
      MenuBar(items: [
        MenuBarItem(
          label: 'File',
          children: [
            const MenuBarChildItem(value: 'new', label: 'New'),
            const MenuBarChildItem(value: 'open', label: 'Open'),
          ],
        ),
      ]),
    );
  ...
  testWidgets('renders dropdown arrow for items with children', (tester) async {
    await pumpTestApp(
      ...
      MenuBar(items: [
        MenuBarItem(
          label: 'File',
          children: [const MenuBarChildItem(value: 'new', label: 'New')],
        ),
      ]),
    );
