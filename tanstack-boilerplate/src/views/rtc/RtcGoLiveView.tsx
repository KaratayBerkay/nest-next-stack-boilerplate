...
function RtcGoLiveForm() {
  ...
  const viewers = useStreamViewers(slug);
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-neutral-950">
      <div className="flex flex-1 overflow-hidden">
        {/* Fixed-fit column: the player flexes to the leftover height and the
            host bar stays pinned below it — nothing scrolls. The old
            overflow-y-auto column let the aspect-video player overflow the
            viewport on wide windows. */}
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          <div className="relative min-h-0 flex-1">
            <StreamPlayer
              ...
              micMuted={!livekit.localMicEnabled}
