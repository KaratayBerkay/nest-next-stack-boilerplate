...
const FAVORITES: FavoriteToken[] = [
  {
    symbol: "BTC",
    letter: "B",
    hue: "bg-warning text-warning-fg",
    price: "$67,420.13",
  },
  {
    symbol: "ETH",
    letter: "E",
    hue: "bg-brand text-brand-fg",
    price: "$3,215.88",
  },
  {
    symbol: "SOL",
    letter: "S",
    hue: "bg-success text-success-fg",
    price: "$152.44",
  },
  {
    symbol: "DOGE",
    letter: "D",
    hue: "bg-error text-error-fg",
    price: "$0.1582",
  },
];
...
const TOP_ASSETS: FavoriteToken[] = [
  ...
  { symbol: "ETH", letter: "E", hue: "bg-brand text-brand-fg", price: "2.15" },
];
      ...
      <div className="mx-auto w-full max-w-6xl px-4 lg:px-8">
        <div className="bg-surface border-border relative flex h-[600px] w-full flex-col overflow-hidden rounded-2xl border">
          ...
          <header className="border-border flex h-14 shrink-0 items-center gap-3 border-b px-4">
            ...
            <div className="bg-surface-hover hidden flex-1 items-center justify-center gap-1 rounded-full p-1 md:flex">
