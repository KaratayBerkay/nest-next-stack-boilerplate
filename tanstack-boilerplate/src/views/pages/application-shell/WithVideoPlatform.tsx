...
const CHANNELS: ChannelItem[] = [
  { name: "TechNova", initials: "TN", hue: "bg-brand text-brand-fg" },
  { name: "DesignLab", initials: "DL", hue: "bg-error text-error-fg" },
  { name: "CodeCraft", initials: "CC", hue: "bg-success text-success-fg" },
  { name: "PixelDaily", initials: "PD", hue: "bg-warning text-warning-fg" },
  { name: "ByteCast", initials: "BC", hue: "bg-info text-info-fg" },
];
            ...
            <div className="hidden flex-1 justify-center md:flex">
              <div className="relative w-full max-w-md">
                <Input
                  ...
                  className="bg-surface-hover h-9 rounded-full pr-4"
