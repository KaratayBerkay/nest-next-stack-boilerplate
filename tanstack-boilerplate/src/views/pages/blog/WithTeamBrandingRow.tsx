...
function BrandLockup({ post, t }: BrandLockupProps) {
  return (
    <div className="flex items-center gap-3">
      <span className="bg-surface-hover flex size-10 shrink-0 items-center justify-center rounded-xl text-sm font-semibold">
        {post.mark}
      </span>
              ...
              <div className="mt-4 grid gap-5 lg:mt-0 lg:grid-cols-[180px_1fr_auto] lg:items-center lg:gap-8">
                ...
                <div className="flex flex-col gap-3">
                  <a
                    ...
                    className="group border-border hover:bg-surface-hover inline-flex w-fit items-center gap-1 rounded-full border px-3 py-1 text-xs font-medium transition-colors"
                  >
                    {t[post.categoryKey]}
                    <IconChevronRight
                      size={12}
