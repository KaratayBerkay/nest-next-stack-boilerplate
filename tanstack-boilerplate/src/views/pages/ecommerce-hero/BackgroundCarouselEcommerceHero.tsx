    ...
    >
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-6 lg:px-8">
        <div className="flex max-w-xl flex-col gap-4">
          <span className="border-white/30 text-white inline-flex w-fit items-center gap-2 rounded-full border px-3 py-1 text-xs font-medium tracking-widest uppercase">
