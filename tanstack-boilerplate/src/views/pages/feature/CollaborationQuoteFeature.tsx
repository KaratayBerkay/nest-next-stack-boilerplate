...
const PRIMARY_IMAGE_SRC = "/img/placeholders/ph-4x3-1.webp" as const;
const SECONDARY_IMAGE_SRC = "/img/placeholders/ph-4x3-3.webp" as const;
const AVATAR_SRC = "/img/placeholders/ph-1x1-4.webp" as const;
