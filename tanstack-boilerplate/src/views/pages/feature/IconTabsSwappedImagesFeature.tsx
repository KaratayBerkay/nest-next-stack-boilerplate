...
const TABS: { id: string; icon: Icon; ariaKey: string; src: string; altKey: string }[] = [
  { id: "speed", icon: IconBolt, ariaKey: "feature105Tab1Aria", src: "/img/placeholders/ph-16x9-1.webp", altKey: "feature105Tab1ImageAlt" },
  { id: "insights", icon: IconChartBar, ariaKey: "feature105Tab2Aria", src: "/img/placeholders/ph-16x9-3.webp", altKey: "feature105Tab2ImageAlt" },
  { id: "cloud", icon: IconCloud, ariaKey: "feature105Tab3Aria", src: "/img/placeholders/ph-16x9-5.webp", altKey: "feature105Tab3ImageAlt" },
];
