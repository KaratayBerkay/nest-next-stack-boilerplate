...
const ROWS = [
  { id: "capture", titleKey: "feature192Row1Title", bodyKey: "feature192Row1Body", altKey: "feature192Row1ImageAlt", src: "/img/placeholders/ph-3x4-0.webp" },
  { id: "refine", titleKey: "feature192Row2Title", bodyKey: "feature192Row2Body", altKey: "feature192Row2ImageAlt", src: "/img/placeholders/ph-3x4-3.webp" },
  { id: "publish", titleKey: "feature192Row3Title", bodyKey: "feature192Row3Body", altKey: "feature192Row3ImageAlt", src: "/img/placeholders/ph-3x4-6.webp" },
] as const;
...
export function AccordionDesktopImageSyncFeature() {
  ...
  return (
    <section className="relative w-full py-16 lg:py-24">
      <div className="hidden lg:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-[38%]">
        <Image
          src={active.src}
          alt={f[active.altKey]}
          fill
