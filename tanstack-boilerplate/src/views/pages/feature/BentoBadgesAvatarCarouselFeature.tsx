...
const BADGE_KEYS = ["feature110Badge1", "feature110Badge2", "feature110Badge3", "feature110Badge4"] as const;
const AVATAR_SRCS = ["/img/placeholders/ph-1x1-0.webp", "/img/placeholders/ph-1x1-2.webp", "/img/placeholders/ph-1x1-4.webp", "/img/placeholders/ph-1x1-6.webp"];
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="border-border bg-surface flex flex-col gap-4 rounded-xl border p-6">
            <h3 className="text-fg text-base font-semibold">{f.feature110BadgesTitle}</h3>
          ...
          <div className="border-border bg-surface flex flex-col gap-4 rounded-xl border p-6">
            <h3 className="text-fg text-base font-semibold">{f.feature110AvatarsTitle}</h3>
