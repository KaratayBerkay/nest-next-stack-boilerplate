...
import { IconArrowRight, IconChartBar, IconShieldCheck } from "@tabler/icons-react";
      ...
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="border-border bg-surface flex flex-col gap-4 rounded-xl border p-8">
            ...
            <h3 className="text-fg text-lg font-semibold">{f.feature5Card1Title}</h3>
            <p className="text-muted text-sm leading-relaxed">{f.feature5Card1Body}</p>
          ...
          <div className="border-border bg-surface flex flex-col gap-4 rounded-xl border p-8">
            ...
            <h3 className="text-fg text-lg font-semibold">{f.feature5Card2Title}</h3>
            <p className="text-muted text-sm leading-relaxed">{f.feature5Card2Body}</p>
            <span className="text-brand mt-auto inline-flex items-center gap-1.5 text-sm font-medium">
              {f.feature5Card2Link}
              <IconArrowRight size={14} aria-hidden="true" />
            </span>
