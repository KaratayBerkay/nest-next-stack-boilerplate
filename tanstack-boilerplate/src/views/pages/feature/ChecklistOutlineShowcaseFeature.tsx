...
const CHECK_KEYS = ["feature22Check1", "feature22Check2", "feature22Check3"] as const;
const CARD_KEYS = [
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="flex flex-col gap-4 text-center">
          ...
          <div className="mt-2 flex flex-wrap justify-center gap-x-6 gap-y-2">
            {CHECK_KEYS.map((key) => (
              <span key={key} className="text-muted inline-flex items-center gap-1.5 text-sm">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3">
          {CARD_KEYS.map((card) => (
            <div key={card.id} className="border-border flex flex-col gap-2 rounded-xl border-2 p-6">
