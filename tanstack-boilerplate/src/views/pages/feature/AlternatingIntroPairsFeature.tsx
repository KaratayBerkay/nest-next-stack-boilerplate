...
const ROWS = [
  { id: "row1", reverse: false, titleKey: "feature31Row1Title", bodyKey: "feature31Row1Body", altKey: "feature31Row1ImageAlt", src: "/img/placeholders/ph-3x2-1.webp" },
  { id: "row2", reverse: true, titleKey: "feature31Row2Title", bodyKey: "feature31Row2Body", altKey: "feature31Row2ImageAlt", src: "/img/placeholders/ph-3x2-4.webp" },
] as const;
