                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex shrink-0 items-center gap-3 sm:self-center">
                      <Badge variant={isConnected ? "success" : "outline"} size="sm">
                        {isConnected ? d.list2ConnectedLabel : d.list2NotConnectedLabel}
                      </Badge>
                      <Button
                      ...
                      >
                        {isConnected ? d.list2ManageButton : d.list2ConnectButton}
                      </Button>
                    </div>
                  </li>
                );
