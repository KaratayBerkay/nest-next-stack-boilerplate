...
const CATEGORIES: CategoryEntry[] = [
  {
    ...
    brands: [
      { id: "fintech-1", icon: IconShieldCheck, nameKey: "logos5FintechBrand1Name" },
      { id: "fintech-2", icon: IconFingerprint, nameKey: "logos5FintechBrand2Name" },
  ...
  },
  {
    ...
    brands: [
      { id: "healthcare-1", icon: IconWaveSine, nameKey: "logos5HealthcareBrand1Name" },
      { id: "healthcare-2", icon: IconLeaf, nameKey: "logos5HealthcareBrand2Name" },
      { id: "healthcare-3", icon: IconDroplet, nameKey: "logos5HealthcareBrand3Name" },
      { id: "healthcare-4", icon: IconMoon, nameKey: "logos5HealthcareBrand4Name" },
    ],
  },
  {
    id: "retail",
  ...
  },
  {
    ...
    brands: [
      { id: "logistics-1", icon: IconWind, nameKey: "logos5LogisticsBrand1Name" },
      { id: "logistics-2", icon: IconCloud, nameKey: "logos5LogisticsBrand2Name" },
      { id: "logistics-3", icon: IconAnchor, nameKey: "logos5LogisticsBrand3Name" },
      { id: "logistics-4", icon: IconRadar, nameKey: "logos5LogisticsBrand4Name" },
    ],
  },
];
