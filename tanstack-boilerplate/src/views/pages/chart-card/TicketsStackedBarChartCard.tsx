...
import { Bar, CartesianGrid, Chart, Legend, Tooltip, XAxis, YAxis } from "@/components/ui/Chart";
      ...
      <div className="border-border bg-bg w-full max-w-lg rounded-2xl border p-6 shadow-xs">
        ...
        <div className="mt-5">
          <Chart type="bar" data={data} height={260}>
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="low" stackId="priority" name={c.chartCard10SeriesLow} fill="var(--success)" />
            <Bar dataKey="medium" stackId="priority" name={c.chartCard10SeriesMedium} fill="var(--info)" />
            <Bar dataKey="high" stackId="priority" name={c.chartCard10SeriesHigh} fill="var(--warning)" />
            <Bar
              dataKey="urgent"
              stackId="priority"
