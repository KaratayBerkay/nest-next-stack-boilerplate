      ...
      <div className="border-border bg-bg w-full max-w-lg rounded-2xl border p-6 shadow-xs">
        ...
        <div className="mt-5">
          <Chart type="line" data={data} height={220}>
            ...
            <YAxis domain={[0, 300]} />
            <Tooltip />
            <ReferenceArea y1={0} y2={150} fill="var(--success)" fillOpacity={0.08} />
            <ReferenceArea y1={150} y2={220} fill="var(--warning)" fillOpacity={0.1} />
            <ReferenceArea y1={220} y2={300} fill="var(--error)" fillOpacity={0.1} />
            <Line
              type="monotone"
              dataKey="latency"
