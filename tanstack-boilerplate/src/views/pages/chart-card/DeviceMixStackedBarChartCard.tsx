...
import { Bar, CartesianGrid, Chart, Tooltip, XAxis, YAxis } from "@/components/ui/Chart";
      ...
      <div className="border-border bg-bg w-full max-w-lg rounded-2xl border p-6 shadow-xs">
        ...
        <div className="mt-5">
          <Chart type="bar" data={data} height={240}>
            ...
            <YAxis domain={[0, 100]} />
            <Tooltip />
            <Bar dataKey="desktop" stackId="device" name={c.chartCard11SeriesDesktop} fill="var(--brand)" />
            <Bar dataKey="mobile" stackId="device" name={c.chartCard11SeriesMobile} fill="var(--info)" />
            <Bar
              dataKey="tablet"
              stackId="device"
