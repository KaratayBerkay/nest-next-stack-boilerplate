        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_300px] lg:gap-14">
          ...
          <aside>
            <div className="flex flex-col gap-6 lg:sticky lg:top-24">
              ...
              <Accordion type="single" collapsible defaultValue="services" className="flex flex-col gap-3">
                <AccordionItem value="services" className="border-border rounded-2xl border">
                ...
                <AccordionItem value="scope" className="border-border rounded-2xl border">
                  <AccordionTrigger className="group gap-4 px-5">
                    <span className="flex-1 text-left">
