  ...
  return (
    <section className="w-full py-16 lg:py-24">
      ...
      <div className="mx-auto mt-8 max-w-xl px-6 lg:px-8">
                ...
                <CommandGroup heading={ps.productSearch5ProductsGroupLabel}>
                  {PRODUCTS.map((product) => (
                    ...
                    >
                      ...
                      <span className="flex-1 truncate">{ps[product.nameKey]}</span>
                ...
                <CommandGroup heading={ps.productSearch5GuidesGroupLabel}>
                  {GUIDES.map((guide) => (
                    <CommandItem
                      ...
                      onSelect={() => setOpen(false)}
                    >
                      <IconBooks size={16} aria-hidden="true" className="text-muted" />
                      {ps[guide.labelKey]}
                    </CommandItem>
                  ))}
                </CommandGroup>
        ...
        <p className="text-muted mt-3 text-center text-xs">{ps.productSearch5Hint}</p>
      </div>
    </section>
  );
}
