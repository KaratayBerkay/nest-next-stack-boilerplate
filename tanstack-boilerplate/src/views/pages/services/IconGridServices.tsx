          ...
          {SERVICES.map((service) => (
            ...
            >
              <span className="border-border bg-surface flex size-11 shrink-0 items-center justify-center rounded-lg border">
                <service.icon size={22} aria-hidden="true" className="text-brand" />
              </span>
              ...
              <ul className="flex flex-col gap-1.5">
                <li className="text-muted flex items-start gap-2 text-sm">
                  <span className="bg-brand mt-1.5 size-1 shrink-0 rounded-full" aria-hidden="true" />
              ...
              <button
                type="button"
                className="text-fg mt-auto flex w-fit items-center gap-1 text-sm font-medium transition-colors group-hover:text-brand"
              >
                {s.services1CtaLabel}
                <IconArrowUpRight
                  size={15}
