...
const STRENGTH_LEVELS: readonly StrengthLevel[] = [
  { labelKey: "resetPassword1StrengthEmpty", textClass: "text-muted", barClass: "bg-border" },
  { labelKey: "resetPassword1StrengthWeak", textClass: "text-error", barClass: "bg-error" },
  { labelKey: "resetPassword1StrengthFair", textClass: "text-warning", barClass: "bg-warning" },
  { labelKey: "resetPassword1StrengthGood", textClass: "text-brand", barClass: "bg-brand" },
  { labelKey: "resetPassword1StrengthStrong", textClass: "text-success", barClass: "bg-success" },
] as const;
        ...
        <CardContent>
          {submitted ? (
            <div className="flex flex-col items-center gap-3 text-center">
              ...
              <p className="text-muted text-sm">{rp.resetPassword1SuccessBody}</p>
                    ...
                    {[0, 1, 2, 3].map((segment) => (
                      <span
                        ...
                        className={cn(
                          ...
                          segment < strengthScore ? strength.barClass : "bg-border",
                        )}
                      />
                    ))}
                  </div>
