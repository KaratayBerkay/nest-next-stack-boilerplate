...
const CATEGORIES: ChipCategory[] = [
  { id: "electronics", nameKey: "productCategories5Item1Name", icon: IconDeviceLaptop, count: 1284 },
  { id: "fashion", nameKey: "productCategories5Item2Name", icon: IconShirt, count: 3920 },
  { id: "home", nameKey: "productCategories5Item3Name", icon: IconHome2, count: 872 },
  { id: "beauty", nameKey: "productCategories5Item4Name", icon: IconSparkles, count: 640 },
  { id: "sports", nameKey: "productCategories5Item5Name", icon: IconBallFootball, count: 1105 },
  { id: "toys", nameKey: "productCategories5Item6Name", icon: IconDeviceGamepad2, count: 480 },
  { id: "books", nameKey: "productCategories5Item7Name", icon: IconBook2, count: 2430 },
  { id: "pets", nameKey: "productCategories5Item8Name", icon: IconPaw, count: 315 },
  { id: "baby", nameKey: "productCategories5Item9Name", icon: IconBabyCarriage, count: 268 },
  { id: "watches", nameKey: "productCategories5Item10Name", icon: IconDeviceWatch, count: 542 },
];
