  ...
  return (
    <footer className="border-border bg-surface w-full border-t">
      <div className="mx-auto max-w-6xl px-6 py-14 lg:px-8">
          ...
          <Card className="flex flex-col gap-5 p-6">
            <div className="flex flex-col gap-2">
              ...
              {subscribed ? (
                <p className="text-muted flex items-center gap-2 text-sm">
                  <IconCheck size={16} className="text-success shrink-0" aria-hidden="true" />
                  {f.ecommerceFooter18NewsletterConfirmedCopy}
                </p>
              ) : (
                <>
                  <p className="text-muted text-sm">{f.ecommerceFooter18NewsletterCopy}</p>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <span className="text-muted flex items-start gap-2 text-sm">
                <IconMapPin size={16} className="mt-0.5 shrink-0" aria-hidden="true" />
        ...
        <span className="text-muted text-xs">{f.ecommerceFooter18Copyright}</span>
      </div>
    </footer>
  );
}
