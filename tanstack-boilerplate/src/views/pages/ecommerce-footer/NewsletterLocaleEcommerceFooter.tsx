      ...
      <div className="mx-auto max-w-6xl px-6 py-12 lg:px-8">
        <div className="grid gap-10 md:grid-cols-3">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-muted text-sm">{f.ecommerceFooter1NewsletterCopy}</p>
            <form onSubmit={handleSubscribe} className="flex max-w-sm gap-2">
              ...
              <Button type="submit" variant="primary" className="shrink-0">
                {subscribed ? f.ecommerceFooter1Subscribed : f.ecommerceFooter1SubscribeCta}
              </Button>
            </form>
          </div>
          ...
          <div className="flex flex-col gap-3 md:items-center">
            ...
            <div className="flex w-full max-w-56 flex-col gap-3">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="ecommerce-footer-1-lang" className="text-muted text-xs">
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="ecommerce-footer-1-currency" className="text-muted text-xs">
                  {f.ecommerceFooter1CurrencyLabel}
                </label>
                <NativeSelect id="ecommerce-footer-1-currency" defaultValue="usd">
        ...
        <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
          <span className="text-muted text-xs">{f.ecommerceFooter1Copyright}</span>
