...
const CHANNEL_POINTS: ChannelPoint[] = [
  { nameKey: "chartGroup13Channel1", value: 42, color: "var(--brand)" },
  { nameKey: "chartGroup13Channel2", value: 26, color: "var(--info)" },
  { nameKey: "chartGroup13Channel3", value: 19, color: "var(--success)" },
  { nameKey: "chartGroup13Channel4", value: 13, color: "var(--warning)" },
];
