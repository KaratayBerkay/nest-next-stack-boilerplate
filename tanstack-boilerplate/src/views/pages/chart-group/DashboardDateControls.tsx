...
const CHANNEL_POINTS: ChannelPoint[] = [
  { nameKey: "chartGroup12Channel1", value: 48, color: "var(--brand)" },
  { nameKey: "chartGroup12Channel2", value: 24, color: "var(--info)" },
  { nameKey: "chartGroup12Channel3", value: 17, color: "var(--success)" },
  { nameKey: "chartGroup12Channel4", value: 11, color: "var(--warning)" },
];
