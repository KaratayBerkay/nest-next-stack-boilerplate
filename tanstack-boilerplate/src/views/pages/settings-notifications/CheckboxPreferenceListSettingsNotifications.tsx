...
export function CheckboxPreferenceListSettingsNotifications() {
  ...
  const [baseline, setBaseline] = useState<Record<string, boolean>>(INITIAL_STATE);
      ...
      <div className="mx-auto max-w-2xl px-6 lg:px-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>{sn.settingsNotifications1Subheading}</CardDescription>
          </CardHeader>
            ...
            <div className="flex w-full items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  onClick={handleSave}
                  leftIcon={
                    justSaved ? <IconCheck size={14} aria-hidden="true" /> : undefined
                  }
                >
                  {justSaved
