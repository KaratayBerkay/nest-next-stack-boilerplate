...
const PHOTOS: AboutImage[] = [
  { src: "/img/placeholders/ph-4x5-4.webp", ratio: 4 / 5 },
  { src: "/img/placeholders/ph-4x5-0.webp", ratio: 4 / 5 },
  { src: "/img/placeholders/ph-4x5-1.webp", ratio: 4 / 5 },
  { src: "/img/placeholders/ph-4x5-6.webp", ratio: 4 / 5 },
  { src: "/img/placeholders/ph-4x5-3.webp", ratio: 4 / 5 },
  { src: "/img/placeholders/ph-4x5-4.webp", ratio: 4 / 5 },
];
    ...
    <section className="w-full py-16 lg:py-24">
      <div className="mx-auto flex max-w-6xl flex-col gap-16 px-4 lg:gap-20 lg:px-8">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:gap-16">
          ...
          <div className="bg-surface flex flex-col justify-center gap-5 rounded-2xl p-8">
