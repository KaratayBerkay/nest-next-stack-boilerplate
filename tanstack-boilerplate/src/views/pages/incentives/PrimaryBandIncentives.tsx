...
import { IconAward, IconShieldCheck, IconTruckDelivery } from "@tabler/icons-react";
...
const ITEMS: BandItem[] = [
  { id: "price-match", icon: IconShieldCheck, titleKey: "incentives2Item1Title" },
  { id: "delivery", icon: IconTruckDelivery, titleKey: "incentives2Item2Title" },
