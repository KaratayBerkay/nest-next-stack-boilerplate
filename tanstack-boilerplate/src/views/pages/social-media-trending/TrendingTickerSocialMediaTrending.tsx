...
const TOPICS: TrendingTopic[] = [
  { id: "smt7-topic-1", rank: 1, labelKey: "socialMediaTrending7Topic1Label", captionKey: "socialMediaTrending7Topic1Caption", count: 84300 },
  { id: "smt7-topic-2", rank: 2, labelKey: "socialMediaTrending7Topic2Label", captionKey: "socialMediaTrending7Topic2Caption", count: 51200 },
  { id: "smt7-topic-3", rank: 3, labelKey: "socialMediaTrending7Topic3Label", captionKey: "socialMediaTrending7Topic3Caption", count: 39750 },
  { id: "smt7-topic-4", rank: 4, labelKey: "socialMediaTrending7Topic4Label", captionKey: "socialMediaTrending7Topic4Caption", count: 27600 },
  { id: "smt7-topic-5", rank: 5, labelKey: "socialMediaTrending7Topic5Label", captionKey: "socialMediaTrending7Topic5Caption", count: 18900 },
  { id: "smt7-topic-6", rank: 6, labelKey: "socialMediaTrending7Topic6Label", captionKey: "socialMediaTrending7Topic6Caption", count: 12100 },
];
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6 px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex flex-col gap-2">
            <Badge variant="error" pill size="sm" className="w-fit gap-1.5">
              <span className="bg-error-fg size-1.5 animate-pulse rounded-full" aria-hidden="true" />
          ...
          <div className="animate-smt7-ticker flex w-max items-center gap-3 px-3">
            {[...TOPICS, ...TOPICS].map((topic, index) => (
              ...
              >
                ...
                <span className="text-fg font-medium">{smt[topic.labelKey]}</span>
        ...
        >
          {selected ? (
            ...
            <p className="text-muted text-sm">{smt.socialMediaTrending7EmptyHint}</p>
          )}
        </div>
      </div>
    </section>
