        ...
        <Dialog>
          ...
          <DialogContent className="max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>{fm.fieldMapping1Description}</DialogDescription>
            </DialogHeader>
            <div className="flex flex-col gap-3 px-6 pb-2">
              ...
              {ROWS.map((row) => (
                <div key={row.id} className="flex items-center gap-3">
                  ...
                  <IconArrowRight size={14} className="text-muted shrink-0" aria-hidden="true" />
                  <Select
                  ...
                  >
                    <SelectTrigger className="w-40 shrink-0">
                      {fm[TARGET_FIELDS.find((f) => f.value === targets[row.id])?.labelKey ?? "fieldMapping1TargetSkip"]}
                    </SelectTrigger>
                    <SelectContent>
            ...
            <DialogFooter>
              <DialogClose variant="ghost">{fm.fieldMapping1Cancel}</DialogClose>
