...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      { id: "reduce-motion", type: "switch", labelKey: "sidebar9AppearanceItem1" },
        ...
        <div className="bg-surface border-border h-[560px] w-full overflow-hidden rounded-2xl border">
          ...
          {activeCategory ? (
            <div className="animate-fade-in-left h-[calc(100%-3.5rem)] overflow-y-auto p-4">
              <Typography variant="h3" className="mb-4 px-1 text-lg font-medium">
              ...
              <div className="flex flex-col gap-1">
                {activeCategory.items.map((item) =>
                  item.type === "switch" ? (
                    ...
                    >
                      <span className="text-fg text-sm">{sb[item.labelKey]}</span>
                      <Switch
            ...
            <div className="h-[calc(100%-3.5rem)] overflow-y-auto p-4">
              <p className="text-muted mb-3 px-1 text-sm">{sb.sidebar9RootHint}</p>
              <div className="flex flex-col gap-1">
