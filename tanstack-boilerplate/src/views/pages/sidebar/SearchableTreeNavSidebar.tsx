...
import { IconChevronRight, IconFileText, IconFolder, IconSearch } from "@tabler/icons-react";
...
function nodeMatches(node: TreeNode, query: string, sb: Record<string, string>): boolean {
