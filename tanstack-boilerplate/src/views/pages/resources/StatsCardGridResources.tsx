...
function sortCourses(items: readonly CourseItem[], mode: SortMode): CourseItem[] {
  const copy = [...items];
  if (mode === "newest") {
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div className="flex max-w-xl flex-col gap-3">
            ...
            <p className="text-muted leading-relaxed">{r.resources5Description}</p>
          </div>
          <div className="flex flex-col gap-1.5">
            <label htmlFor="resources5-sort" className="text-muted text-xs font-medium">
                ...
                <CardContent className="flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    <Avatar
                      ...
                      size="xs"
                    />
                    <span className="text-fg text-sm font-medium">{authorName}</span>
                  </div>
                  <div className="border-border text-muted flex items-center justify-between border-t pt-4 text-xs">
                    ...
                    <span className="text-fg flex items-center gap-1 font-medium">
                      <IconStarFilled size={14} className="text-warning" aria-hidden="true" />
                      {r[course.ratingKey]}
                    </span>
                  </div>
                </CardContent>
