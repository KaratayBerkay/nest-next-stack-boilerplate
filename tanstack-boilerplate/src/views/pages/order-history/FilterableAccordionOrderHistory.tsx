      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8 px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-end gap-6">
          <div className="flex flex-col gap-2">
            <label htmlFor="order-history-2-range" className="text-sm font-medium">
                ...
                <AccordionItemComplex
                  ...
                  centerSlot={
                    <div className="flex flex-col gap-0.5">
                      <span className="text-fg font-medium">{order.number}</span>
                      ...
                      <div className="flex flex-col gap-1.5 text-sm">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="tabular-nums">
                            {formatMoney(order.subtotal, d.orderHistory2Currency)}
                          </span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-muted">
