          ...
          <div className="flex items-center gap-2">
            {SHARE_ACTIONS.map((action) => (
              <button
                ...
                className="border-border bg-surface text-muted hover:bg-surface-hover hover:text-fg flex size-9 items-center justify-center rounded-full border transition-colors focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none"
              >
          ...
          {SECTIONS.map((section) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "rounded-full px-3.5 py-1.5 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none",
                  isActive
          ...
          {feedback ? (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="border-border hover:bg-surface-hover text-muted hover:text-fg flex size-9 items-center justify-center rounded-full border transition-colors focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none"
              >
