  ...
  return (
    <header className="border-border bg-bg z-50 flex h-14 shrink-0 items-center border-b">
      ...
      <button onClick={open} className="flex h-full items-center gap-2 px-4">
        <div className="bg-brand text-brand-fg flex h-7 w-7 items-center justify-center rounded-lg text-[11px] font-bold">
          V
        </div>
            ...
            <>
              ...
              >
                <Avatar
                  ...
                  className="bg-brand ring-border text-brand-fg h-8 w-8 shrink-0 text-[11px] ring-2"
                />
              </ProfileDropdown>
            </>
          ) : (
