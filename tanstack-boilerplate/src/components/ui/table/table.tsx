...
>(({ className, ...props }, ref) => {
  // Scrollbars are hidden app-wide; the wrapper fades its edges while more
  // columns are off-screen so horizontal overflow stays discoverable.
  const wrapperRef = useScrollFadeX<HTMLDivElement>();
  return (
    <div
      ref={wrapperRef}
      className="border-border relative w-full overflow-auto rounded-lg border"
    >
      <table
        ref={ref}
