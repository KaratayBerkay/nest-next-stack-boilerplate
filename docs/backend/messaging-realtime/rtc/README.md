...
| [`rtc-stream.service.ts`](../../../../nest-js-boilerplate/src/rtc/rtc-stream.service.ts) | Live-stream lifecycle: tier-gated goLive, viewer join/leave (with live viewer counts off LiveKit's participant list), peak-viewer tracking, discovery list |
