...
| [`remove_payment_method.dart`](../../../../../flutter-boilerplate/lib/api/server/billing/remove_payment_method.dart) | Direct GraphQL | `mutation RemovePaymentMethod($paymentMethodId)` | [`removePaymentMethod`](../../../../backend/billing-usage/billing/endpoints.md#remove-a-payment-method) — **used here**, unlike web (see ⚠ `CROSS-034` (resolved)) |
