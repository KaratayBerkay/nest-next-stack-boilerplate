...
- [MOB-006](../../../../issues.md#mob-006) —
  [`settings_select.dart`](../../../../../flutter-boilerplate/lib/views/settings/general/settings_select.dart)'s
  `SettingsSelect` widget is fully built and **never used** (`grep -rln "SettingsSelect("
