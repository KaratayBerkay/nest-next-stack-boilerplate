...
| [`profile/get.dart`](../../../../flutter-boilerplate/lib/api/server/profile/get.dart)'s `profileGetServerProvider` | Direct GraphQL | `query MyProfile` | [social-content/profile/endpoints.md#get-my-profile](../../../backend/social-content/profile/endpoints.md#get-my-profile) — see `MOB-003` (resolved), always self-scoped regardless of caller intent |
...
- [detail/screen.md](./detail/screen.md) → `profileGetServerProvider` →
  ...
  (always self-scoped — see `MOB-003` (resolved)); "Add Friend" button →
...
- `MOB-003` (resolved) — see [detail/screen.md § Known issues](./detail/screen.md#known-issues).
