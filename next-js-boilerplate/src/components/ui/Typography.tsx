...
export function H4({ className, ...props }: React.ComponentPropsWithoutRef<"h4">) {
...
export function Large({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
...
export function Muted({ className, ...props }: React.ComponentPropsWithoutRef<"p">) {
  return <p className={cn("text-muted text-sm", className)} {...props} />;
}

export function Code({ className, ...props }: React.ComponentPropsWithoutRef<"code">) {
  return <code className={cn("bg-surface relative rounded px-[0.3rem] py-[0.2rem] font-mono text-sm", className)} {...props} />;
}

export function Quote({ className, ...props }: React.ComponentPropsWithoutRef<"blockquote">) {
  return <blockquote className={cn("border-border mt-6 border-l-2 pl-6 italic", className)} {...props} />;
}
