...
const variants = {
  ...globalStyleVariants,
  default:
    "data-[state=active]:bg-surface-hover data-[state=active]:text-fg data-[state=active]:shadow-sm data-[state=active]:ring-1 data-[state=active]:ring-border data-[state=inactive]:text-muted data-[state=inactive]:hover:text-fg data-[state=inactive]:hover:bg-surface-hover/50",
  underline:
