  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button:
          "hover:bg-surface-hover inline-flex w-full items-center justify-center rounded-md px-0 py-2 text-sm font-normal transition-colors aria-selected:opacity-100",
        selected:
      ...
      components={{
        ...
        DayButton: (dayButtonProps) => {
          ...
          if (dayButtonProps.modifiers.outside) {
            return (
              <span
                className="inline-flex w-full items-center justify-center px-0 py-2 text-sm font-normal"
                aria-hidden="true"
              >
                {dayDate.getDate()}
              </span>
          ...
          return (
            <button
              className={cn(
                "hover:bg-surface-hover inline-flex w-full items-center justify-center rounded-md px-0 py-2 text-sm font-normal transition-colors",
