...
import type { UsageTabProps } from "@/types/settings/UsageTab-types";
...
export function UsageTab({ className }: UsageTabProps) {
    ...
    return (
      <div className={cn("flex flex-col gap-4", className)}>
        <Card variant="surface" className="p-5">
          ...
          <div className="bg-surface mt-4 h-2 w-full animate-pulse rounded" />
        </Card>
      </div>
    );
  }
