...
const TABS: PackageManagerTab[] = [
  {
    id: "npm",
    labelKey: "hero5TabNpm",
    command: "npm install @northline/client",
  },
  {
    id: "pnpm",
    labelKey: "hero5TabPnpm",
    command: "pnpm add @northline/client",
  },
  {
    id: "yarn",
    labelKey: "hero5TabYarn",
    command: "yarn add @northline/client",
  },
];
