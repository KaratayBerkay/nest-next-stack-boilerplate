    ...
    <section className="w-full py-16 lg:py-24">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div
          ...
          role="list"
          className="border-border before:bg-border relative mt-12 flex snap-x snap-mandatory [scrollbar-width:none] gap-6 overflow-x-auto pt-6 pb-4 before:absolute before:top-9 before:right-0 before:left-0 before:h-px [&::-webkit-scrollbar]:hidden"
        >
          {PHASES.map((phase) => (
            <div
              key={phase.id}
            ...
            >
              <span
                className="border-border bg-brand border-bg relative z-10 mb-4 block size-4 rounded-full border-2"
                aria-hidden="true"
              />
