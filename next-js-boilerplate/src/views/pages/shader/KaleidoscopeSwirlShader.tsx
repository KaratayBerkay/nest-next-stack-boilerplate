    ...
    <section className="w-full py-16 lg:py-24">
      ...
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="border-border bg-surface relative flex min-h-[28rem] items-center justify-center overflow-hidden rounded-2xl border p-8 lg:p-12">
          ...
          >
            <span
              className="shader7-disc-a absolute size-[26rem] rounded-full mix-blend-overlay blur-2xl lg:size-[32rem]"
              style={{
                background:
            ...
            />
            <span
              className="shader7-disc-b absolute size-[22rem] rounded-full mix-blend-overlay blur-2xl lg:size-[28rem]"
              style={{
                background:
