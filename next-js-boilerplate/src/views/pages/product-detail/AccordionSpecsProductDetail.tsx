...
const CATEGORIES: SpecCategory[] = [
  {
    ...
    rows: [
      {
        labelKey: "productDetail1BuildRow1Label",
        valueKey: "productDetail1BuildRow1Value",
      },
      {
        labelKey: "productDetail1BuildRow2Label",
        valueKey: "productDetail1BuildRow2Value",
      },
      {
        labelKey: "productDetail1BuildRow3Label",
        valueKey: "productDetail1BuildRow3Value",
      },
    ],
  },
  {
    ...
    rows: [
      {
        labelKey: "productDetail1FitRow1Label",
        valueKey: "productDetail1FitRow1Value",
      },
      {
        labelKey: "productDetail1FitRow2Label",
        valueKey: "productDetail1FitRow2Value",
      },
      {
        labelKey: "productDetail1FitRow3Label",
        valueKey: "productDetail1FitRow3Value",
      },
    ],
  },
  {
    ...
    rows: [
      {
        labelKey: "productDetail1CareRow1Label",
        valueKey: "productDetail1CareRow1Value",
      },
      {
        labelKey: "productDetail1CareRow2Label",
        valueKey: "productDetail1CareRow2Value",
      },
      {
        labelKey: "productDetail1CareRow3Label",
        valueKey: "productDetail1CareRow3Value",
      },
    ],
  },
];
