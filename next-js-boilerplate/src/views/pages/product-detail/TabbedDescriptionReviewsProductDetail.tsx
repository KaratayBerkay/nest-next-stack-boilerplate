...
const SPEC_ROWS: SpecRow[] = [
  {
    labelKey: "productDetail7SpecRow1Label",
    valueKey: "productDetail7SpecRow1Value",
  },
  {
    labelKey: "productDetail7SpecRow2Label",
    valueKey: "productDetail7SpecRow2Value",
  },
  {
    labelKey: "productDetail7SpecRow3Label",
    valueKey: "productDetail7SpecRow3Value",
  },
];
        ...
        >
          <TabsList>
            <TabsTrigger value="description">
              {pd.productDetail7DescTabLabel}
            </TabsTrigger>
            <TabsTrigger value="specs">
              {pd.productDetail7SpecsTabLabel}
            </TabsTrigger>
            <TabsTrigger value="reviews">
              {pd.productDetail7ReviewsTabLabel}
            </TabsTrigger>
          </TabsList>
