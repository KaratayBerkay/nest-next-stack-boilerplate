...
const TRUST_ITEMS: TrustItem[] = [
  {
    icon: IconTruck,
    labelKey: "productDetail8TrustShippingLabel",
    subKey: "productDetail8TrustShippingSub",
  },
  {
    icon: IconArrowBackUp,
    labelKey: "productDetail8TrustReturnsLabel",
    subKey: "productDetail8TrustReturnsSub",
  },
  {
    icon: IconLock,
    labelKey: "productDetail8TrustSecureLabel",
    subKey: "productDetail8TrustSecureSub",
  },
];
