...
const CATEGORIES: ScrollCategory[] = [
  {
    id: "electronics",
    nameKey: "productCategories4Item1Name",
    icon: IconDeviceLaptop,
    count: 1284,
    seed: "pc4-electronics",
  },
  {
    id: "fashion",
    nameKey: "productCategories4Item2Name",
    icon: IconHanger,
    count: 3920,
    seed: "pc4-fashion",
  },
  {
    id: "home",
    nameKey: "productCategories4Item3Name",
    icon: IconFridge,
    count: 1560,
    seed: "pc4-home",
  },
  {
    id: "beauty",
    nameKey: "productCategories4Item4Name",
    icon: IconSparkles,
    count: 640,
    seed: "pc4-beauty",
  },
  {
    id: "sports",
    nameKey: "productCategories4Item5Name",
  ...
  {
    id: "toys",
    nameKey: "productCategories4Item6Name",
  ...
  {
    id: "books",
    nameKey: "productCategories4Item7Name",
    icon: IconBook2,
    count: 2430,
    seed: "pc4-books",
  },
  {
    id: "pets",
    nameKey: "productCategories4Item8Name",
    icon: IconPaw,
    count: 315,
    seed: "pc4-pets",
  },
