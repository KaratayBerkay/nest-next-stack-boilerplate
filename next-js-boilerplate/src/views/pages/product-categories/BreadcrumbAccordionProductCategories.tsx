...
const CATEGORIES: ParentCategory[] = [
  {
    ...
    subcategories: [
      {
        id: "laptops",
        nameKey: "productCategories3Parent1Sub1Name",
        count: 214,
      },
      {
        id: "phones",
        nameKey: "productCategories3Parent1Sub2Name",
        count: 356,
      },
  ...
  },
  {
    ...
    subcategories: [
      {
        id: "women",
        nameKey: "productCategories3Parent2Sub1Name",
        count: 1240,
      },
      { id: "men", nameKey: "productCategories3Parent2Sub2Name", count: 860 },
      {
        id: "shoes-bags",
        nameKey: "productCategories3Parent2Sub3Name",
        count: 512,
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        id: "furniture",
        nameKey: "productCategories3Parent3Sub1Name",
        count: 340,
      },
      {
        id: "kitchen",
        nameKey: "productCategories3Parent3Sub2Name",
        count: 275,
      },
  ...
  },
  {
    ...
    subcategories: [
      {
        id: "fitness",
        nameKey: "productCategories3Parent4Sub1Name",
        count: 165,
      },
      {
        id: "camping",
        nameKey: "productCategories3Parent4Sub2Name",
        count: 98,
      },
      {
        id: "cycling",
        nameKey: "productCategories3Parent4Sub3Name",
        count: 74,
      },
    ],
  },
      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        >
          ...
          <span className="text-fg font-medium">
            {pc[activeParent.nameKey]}
          </span>
          <IconChevronRight size={14} aria-hidden="true" />
          <span className="text-brand font-medium">
            {pc[activeSub.nameKey]}
          </span>
        </nav>
