...
const COLUMNS: ServiceColumn[] = [
  {
    id: "essentials",
    nameKey: "services2Service1Name",
    taglineKey: "services2Service1Tagline",
  },
  {
    id: "growth",
  ...
  {
    id: "scale",
    nameKey: "services2Service3Name",
    taglineKey: "services2Service3Tagline",
  },
  {
    id: "enterprise",
    nameKey: "services2Service4Name",
    taglineKey: "services2Service4Tagline",
  },
];
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mt-12">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="bg-bg w-40">
                  {s.services2ColHeader}
                </TableHead>
                {COLUMNS.map((column) => (
                  <TableHead
                    key={column.id}
