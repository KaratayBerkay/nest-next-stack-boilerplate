...
const HASHTAGS: Hashtag[] = [
  {
    id: "travel",
    labelKey: "socialMediaTrending5Tag1Label",
    countKey: "socialMediaTrending5Tag1Count",
    weight: "lg",
  },
  {
    id: "foodie",
    labelKey: "socialMediaTrending5Tag2Label",
    countKey: "socialMediaTrending5Tag2Count",
    weight: "md",
  },
  {
    id: "techlaunch",
    labelKey: "socialMediaTrending5Tag3Label",
    countKey: "socialMediaTrending5Tag3Count",
    weight: "lg",
  },
  {
    id: "fitness",
    labelKey: "socialMediaTrending5Tag4Label",
    countKey: "socialMediaTrending5Tag4Count",
    weight: "sm",
  },
  {
    id: "diy",
    labelKey: "socialMediaTrending5Tag5Label",
    countKey: "socialMediaTrending5Tag5Count",
    weight: "md",
  },
  {
    id: "music",
    labelKey: "socialMediaTrending5Tag6Label",
    countKey: "socialMediaTrending5Tag6Count",
    weight: "sm",
  },
];
...
const POSTS: TaggedPost[] = [
  {
    id: "smt5-post-1",
    tagId: "travel",
    handleKey: "socialMediaTrending5Post1Handle",
    captionKey: "socialMediaTrending5Post1Caption",
    likes: 412,
    comments: 38,
  },
  {
    id: "smt5-post-2",
    tagId: "techlaunch",
    handleKey: "socialMediaTrending5Post2Handle",
    captionKey: "socialMediaTrending5Post2Caption",
    likes: 1290,
    comments: 204,
  },
  {
    id: "smt5-post-3",
    tagId: "foodie",
    handleKey: "socialMediaTrending5Post3Handle",
    captionKey: "socialMediaTrending5Post3Caption",
    likes: 156,
    comments: 22,
  },
  {
    id: "smt5-post-4",
    tagId: "travel",
    handleKey: "socialMediaTrending5Post4Handle",
    captionKey: "socialMediaTrending5Post4Caption",
    likes: 89,
    comments: 11,
  },
  {
    id: "smt5-post-5",
    tagId: "diy",
    handleKey: "socialMediaTrending5Post5Handle",
    captionKey: "socialMediaTrending5Post5Caption",
    likes: 233,
    comments: 19,
  },
];
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    "ml-1.5",
                    isActive ? "text-brand-fg/75" : "text-muted",
                  )}
                >
                  {smt[tag.countKey]}
                </span>
