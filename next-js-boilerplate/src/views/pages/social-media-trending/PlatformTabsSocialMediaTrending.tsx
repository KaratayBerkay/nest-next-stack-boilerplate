...
const X_POSTS: XPost[] = [
  {
    id: "smt4-x-1",
    handleKey: "socialMediaTrending4XPost1Handle",
    textKey: "socialMediaTrending4XPost1Text",
    likes: 214,
    reposts: 38,
  },
  {
    id: "smt4-x-2",
    handleKey: "socialMediaTrending4XPost2Handle",
    textKey: "socialMediaTrending4XPost2Text",
    likes: 1092,
    reposts: 301,
  },
  {
    id: "smt4-x-3",
    handleKey: "socialMediaTrending4XPost3Handle",
    textKey: "socialMediaTrending4XPost3Text",
    likes: 57,
    reposts: 6,
  },
];
...
const INSTAGRAM_POSTS: ImagePost[] = [
  {
    id: "smt4-ig-1",
    seed: "smt4-ig-1",
    handleKey: "socialMediaTrending4InstagramPost1Handle",
    captionKey: "socialMediaTrending4InstagramPost1Caption",
    likes: 812,
  },
  {
    id: "smt4-ig-2",
    seed: "smt4-ig-2",
    handleKey: "socialMediaTrending4InstagramPost2Handle",
    captionKey: "socialMediaTrending4InstagramPost2Caption",
    likes: 245,
  },
  {
    id: "smt4-ig-3",
    seed: "smt4-ig-3",
    handleKey: "socialMediaTrending4InstagramPost3Handle",
    captionKey: "socialMediaTrending4InstagramPost3Caption",
    likes: 3067,
  },
];
...
const TIKTOK_POSTS: ImagePost[] = [
  {
    id: "smt4-tt-1",
    seed: "smt4-tt-1",
    handleKey: "socialMediaTrending4TiktokPost1Handle",
    captionKey: "socialMediaTrending4TiktokPost1Caption",
    likes: 5420,
  },
  {
    id: "smt4-tt-2",
    seed: "smt4-tt-2",
    handleKey: "socialMediaTrending4TiktokPost2Handle",
    captionKey: "socialMediaTrending4TiktokPost2Caption",
    likes: 918,
  },
  {
    id: "smt4-tt-3",
    seed: "smt4-tt-3",
    handleKey: "socialMediaTrending4TiktokPost3Handle",
    captionKey: "socialMediaTrending4TiktokPost3Caption",
    likes: 12300,
  },
];
