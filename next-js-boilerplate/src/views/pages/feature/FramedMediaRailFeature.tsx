...
const CARDS: { id: string; icon: Icon; titleKey: string; bodyKey: string }[] = [
  {
    id: "insights",
    icon: IconChartBar,
    titleKey: "feature168Card1Title",
    bodyKey: "feature168Card1Body",
  },
  {
    id: "cloud",
    icon: IconCloud,
    titleKey: "feature168Card2Title",
    bodyKey: "feature168Card2Body",
  },
  {
    id: "secure",
    icon: IconLock,
    titleKey: "feature168Card3Title",
    bodyKey: "feature168Card3Body",
  },
];
