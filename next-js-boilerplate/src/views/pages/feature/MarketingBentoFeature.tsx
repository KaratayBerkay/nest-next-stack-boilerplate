      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-3">
          <div className="border-border bg-surface relative aspect-[4/5] overflow-hidden rounded-lg border sm:aspect-[3/2] lg:row-span-2 lg:aspect-auto">
            <Image
              src="https://picsum.photos/seed/feature261-tall/800/1000"
          ...
          <div className="border-border bg-surface flex flex-col gap-4 rounded-lg border p-6">
            <AvatarGroup max={5}>
              {AVATARS.map((avatar) => (
                <Avatar
                  key={avatar.seed}
                  src={`https://picsum.photos/seed/${avatar.seed}/64/64`}
          ...
          <div className="border-border bg-surface overflow-hidden rounded-lg border">
            <div className="aspect-[16/9]">
              <Image
                src="https://picsum.photos/seed/feature261-wide/800/450"
