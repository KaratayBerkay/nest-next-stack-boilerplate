...
type SocialPlatform =
  "twitter" | "github" | "linkedin" | "instagram" | "website";
...
export function SocialLinksManagerSettingsProfile() {
  ...
  const platformOptions: Array<{
  ...
  }> = [
    {
      value: "twitter",
      icon: IconBrandX,
      label: sp.settingsProfile8PlatformTwitter,
    },
    {
      value: "github",
      icon: IconBrandGithub,
      label: sp.settingsProfile8PlatformGithub,
    },
    {
      value: "linkedin",
      icon: IconBrandLinkedin,
      label: sp.settingsProfile8PlatformLinkedin,
    },
    {
      value: "instagram",
      icon: IconBrandInstagram,
      label: sp.settingsProfile8PlatformInstagram,
    },
    {
      value: "website",
      icon: IconWorld,
      label: sp.settingsProfile8PlatformWebsite,
    },
  ];
  ...
  const [links, setLinks] = useState<SocialLink[]>([
    {
      id: "seed-1",
      platform: "twitter",
      url: sp.settingsProfile8SeedTwitterUrl,
    },
    { id: "seed-2", platform: "github", url: sp.settingsProfile8SeedGithubUrl },
    {
      id: "seed-3",
      platform: "website",
      url: sp.settingsProfile8SeedWebsiteUrl,
    },
  ]);
              ...
              {links.map((link) => {
                ...
                return (
                  <div key={link.id} className="flex items-center gap-2">
                    <PlatformIcon
                      size={16}
                      className="text-muted hidden shrink-0 sm:block"
                      aria-hidden="true"
                    />
                    <NativeSelect
                      value={link.platform}
