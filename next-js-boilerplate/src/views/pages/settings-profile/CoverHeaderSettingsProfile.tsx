        ...
        <div className="border-border overflow-hidden rounded-xl border">
          ...
          <div className="bg-surface flex flex-col gap-5 px-6 pt-0 pb-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="ch-location">
                  {sp.settingsProfile1LocationLabel}
                </Label>
                <Input
                  id="ch-location"
                  value={location}
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="ch-website">
                  {sp.settingsProfile1WebsiteLabel}
                </Label>
                <Input
                  id="ch-website"
                  value={website}
            ...
            <div className="flex items-center justify-end gap-3">
              {saved && (
                <span className="text-success text-xs">
                  {sp.settingsProfile1SavedBadge}
                </span>
              )}
              <Button variant="primary" loading={saving} onClick={handleSave}>
                {saving
                  ? sp.settingsProfile1SavingButton
                  : sp.settingsProfile1SaveButton}
              </Button>
            </div>
          </div>
        </div>
