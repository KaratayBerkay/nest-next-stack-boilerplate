...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer11ColProductTitle",
    linkKeys: ["footer11ColProductLink1", "footer11ColProductLink2"],
  },
  {
    id: "company",
    titleKey: "footer11ColCompanyTitle",
    linkKeys: ["footer11ColCompanyLink1", "footer11ColCompanyLink2"],
  },
] as const;
const SOCIALS = [
