...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer23ColProductTitle",
    linkKeys: ["footer23ColProductLink1", "footer23ColProductLink2"],
  },
  {
    id: "company",
    titleKey: "footer23ColCompanyTitle",
    linkKeys: ["footer23ColCompanyLink1", "footer23ColCompanyLink2"],
  },
] as const;
