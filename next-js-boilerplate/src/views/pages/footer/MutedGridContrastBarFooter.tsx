...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer52ColProductTitle",
    linkKeys: ["footer52ColProductLink1", "footer52ColProductLink2"],
  },
  {
    id: "company",
    titleKey: "footer52ColCompanyTitle",
    linkKeys: ["footer52ColCompanyLink1", "footer52ColCompanyLink2"],
  },
  {
    id: "resources",
    titleKey: "footer52ColResourcesTitle",
    linkKeys: ["footer52ColResourcesLink1", "footer52ColResourcesLink2"],
  },
] as const;
