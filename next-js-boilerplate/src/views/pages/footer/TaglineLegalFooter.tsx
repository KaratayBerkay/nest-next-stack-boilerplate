...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer2ColProductTitle",
    linkKeys: ["footer2ColProductLink1", "footer2ColProductLink2"],
  },
  {
    id: "company",
    titleKey: "footer2ColCompanyTitle",
    linkKeys: ["footer2ColCompanyLink1", "footer2ColCompanyLink2"],
  },
  {
    id: "legal",
    titleKey: "footer2ColLegalTitle",
    linkKeys: ["footer2ColLegalLink1", "footer2ColLegalLink2"],
  },
] as const;
