...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer6ColProductTitle",
    linkKeys: [
      "footer6ColProductLink1",
      "footer6ColProductLink2",
      "footer6ColProductLink3",
    ],
  },
  {
    id: "support",
    titleKey: "footer6ColSupportTitle",
    linkKeys: [
      "footer6ColSupportLink1",
      "footer6ColSupportLink2",
      "footer6ColSupportLink3",
    ],
  },
] as const;
