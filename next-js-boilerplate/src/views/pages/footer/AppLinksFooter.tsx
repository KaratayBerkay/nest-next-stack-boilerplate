...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer5ColProductTitle",
    linkKeys: [
      "footer5ColProductLink1",
      "footer5ColProductLink2",
      "footer5ColProductLink3",
    ],
  },
  {
    id: "company",
    titleKey: "footer5ColCompanyTitle",
    linkKeys: [
      "footer5ColCompanyLink1",
      "footer5ColCompanyLink2",
      "footer5ColCompanyLink3",
    ],
  },
  {
    id: "legal",
    titleKey: "footer5ColLegalTitle",
    linkKeys: [
      "footer5ColLegalLink1",
      "footer5ColLegalLink2",
      "footer5ColLegalLink3",
    ],
  },
] as const;
const SOCIALS = [
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="border-border mt-10 flex flex-col items-center gap-4 border-t pt-6 sm:flex-row sm:justify-between">
          <div className="flex gap-2">
            <Link
              href="#"
              className="border-border bg-surface inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-xs font-medium"
            >
