...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer1ColProductTitle",
    linkKeys: [
      "footer1ColProductLink1",
      "footer1ColProductLink2",
      "footer1ColProductLink3",
    ],
  },
  {
    id: "company",
    titleKey: "footer1ColCompanyTitle",
    linkKeys: [
      "footer1ColCompanyLink1",
      "footer1ColCompanyLink2",
      "footer1ColCompanyLink3",
    ],
  },
  {
    id: "resources",
    titleKey: "footer1ColResourcesTitle",
    linkKeys: [
      "footer1ColResourcesLink1",
      "footer1ColResourcesLink2",
      "footer1ColResourcesLink3",
    ],
  },
] as const;
