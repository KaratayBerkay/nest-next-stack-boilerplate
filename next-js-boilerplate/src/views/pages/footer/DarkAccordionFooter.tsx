...
const SECTIONS = [
  {
    id: "product",
    titleKey: "footer16ColProductTitle",
    linkKeys: [
      "footer16ColProductLink1",
      "footer16ColProductLink2",
      "footer16ColProductLink3",
    ],
  },
  {
    id: "company",
    titleKey: "footer16ColCompanyTitle",
    linkKeys: [
      "footer16ColCompanyLink1",
      "footer16ColCompanyLink2",
      "footer16ColCompanyLink3",
    ],
  },
  {
    id: "resources",
    titleKey: "footer16ColResourcesTitle",
    linkKeys: [
      "footer16ColResourcesLink1",
      "footer16ColResourcesLink2",
      "footer16ColResourcesLink3",
    ],
  },
] as const;
const SOCIALS = [
