...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer24ColProductTitle",
    linkKeys: [
      "footer24ColProductLink1",
      "footer24ColProductLink2",
      "footer24ColProductLink3",
    ],
  },
  {
    id: "company",
    titleKey: "footer24ColCompanyTitle",
    linkKeys: [
      "footer24ColCompanyLink1",
      "footer24ColCompanyLink2",
      "footer24ColCompanyLink3",
    ],
  },
] as const;
const SOCIALS = [
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-wrap gap-x-8 gap-y-3">
          <a
            ...
            className="text-fg inline-flex items-center gap-2 text-sm font-medium"
          >
