...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer8ColProductTitle",
    linkKeys: ["footer8ColProductLink1", "footer8ColProductLink2"],
  },
  {
    id: "company",
    titleKey: "footer8ColCompanyTitle",
    linkKeys: ["footer8ColCompanyLink1", "footer8ColCompanyLink2"],
  },
] as const;
const SOCIALS = [
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="border-border grid gap-8 border-t pt-8 sm:grid-cols-3">
          ...
          <div className="flex flex-col gap-2.5">
            <span className="text-fg text-sm font-semibold">
              {f.footer8NewsletterTitle}
            </span>
            <form className="flex flex-col gap-2">
              <Input
                type="email"
                placeholder={f.footer8NewsletterPlaceholder}
              />
