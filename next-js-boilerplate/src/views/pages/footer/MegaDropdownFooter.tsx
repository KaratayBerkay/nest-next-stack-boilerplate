...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer17ColProductTitle",
    linkKeys: [
      "footer17ColProductLink1",
      "footer17ColProductLink2",
      "footer17ColProductLink3",
      "footer17ColProductLink4",
    ],
  },
  {
    id: "developers",
    titleKey: "footer17ColDevelopersTitle",
    linkKeys: [
      "footer17ColDevelopersLink1",
      "footer17ColDevelopersLink2",
      "footer17ColDevelopersLink3",
      "footer17ColDevelopersLink4",
    ],
  },
  {
    id: "company",
    titleKey: "footer17ColCompanyTitle",
    linkKeys: [
      "footer17ColCompanyLink1",
      "footer17ColCompanyLink2",
      "footer17ColCompanyLink3",
      "footer17ColCompanyLink4",
    ],
  },
  {
    id: "legal",
    titleKey: "footer17ColLegalTitle",
    linkKeys: [
      "footer17ColLegalLink1",
      "footer17ColLegalLink2",
      "footer17ColLegalLink3",
      "footer17ColLegalLink4",
    ],
  },
] as const;
