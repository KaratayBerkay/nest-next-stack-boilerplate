...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer18ColProductTitle",
    linkKeys: ["footer18ColProductLink1", "footer18ColProductLink2"],
  },
  {
    id: "company",
    titleKey: "footer18ColCompanyTitle",
    linkKeys: ["footer18ColCompanyLink1", "footer18ColCompanyLink2"],
  },
] as const;
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              <Link
                href="#"
                aria-label={f.footer18Social1Aria}
              ...
              <Link
                href="#"
                aria-label={f.footer18Social2Aria}
                className="text-muted hover:text-fg"
              >
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <Select value={lang} onValueChange={setLang} name="footer-18-lang">
              <SelectTrigger className="w-32">
                ...
                {
                  f[
                    LANGUAGES.find((l) => l.value === lang)?.labelKey ??
                      "footer18LangEn"
                  ]
                }
              </SelectTrigger>
            ...
            <Dialog>
              <DialogTrigger
                variant="ghost"
                className="justify-start px-0 text-sm font-normal"
              >
