...
const COLUMNS = [
  {
    id: "product",
    titleKey: "footer7ColProductTitle",
    linkKeys: [
      "footer7ColProductLink1",
      "footer7ColProductLink2",
      "footer7ColProductLink3",
    ],
  },
  {
    id: "company",
    titleKey: "footer7ColCompanyTitle",
    linkKeys: [
      "footer7ColCompanyLink1",
      "footer7ColCompanyLink2",
      "footer7ColCompanyLink3",
    ],
  },
  {
    id: "resources",
    titleKey: "footer7ColResourcesTitle",
    linkKeys: [
      "footer7ColResourcesLink1",
      "footer7ColResourcesLink2",
      "footer7ColResourcesLink3",
    ],
  },
] as const;
const SOCIALS = [
