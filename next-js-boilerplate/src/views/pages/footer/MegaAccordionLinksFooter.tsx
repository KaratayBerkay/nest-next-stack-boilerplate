...
const SECTIONS = [
  {
    id: "product",
    titleKey: "footer49ColProductTitle",
    linkKeys: [
      "footer49ColProductLink1",
      "footer49ColProductLink2",
      "footer49ColProductLink3",
    ],
  },
  {
    id: "solutions",
    titleKey: "footer49ColSolutionsTitle",
    linkKeys: ["footer49ColSolutionsLink1", "footer49ColSolutionsLink2"],
  },
  {
    id: "company",
    titleKey: "footer49ColCompanyTitle",
    linkKeys: ["footer49ColCompanyLink1", "footer49ColCompanyLink2"],
  },
  {
    id: "legal",
    titleKey: "footer49ColLegalTitle",
    linkKeys: ["footer49ColLegalLink1", "footer49ColLegalLink2"],
  },
] as const;
  ...
  return (
    <footer className="border-border bg-surface w-full border-t py-16">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <span className="text-muted mt-6 block text-xs">
          {f.footer49Copyright}
        </span>
      </div>
    </footer>
