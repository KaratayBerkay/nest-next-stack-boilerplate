          ...
          {SECTIONS.map((section) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "focus-visible:ring-brand shrink-0 rounded-md px-3.5 py-1.5 text-sm whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:outline-none",
                  isActive
