...
const TIERS: PricingTier[] = [
  {
    ...
    featureKeys: [
      "service4Tier1Feature1",
      "service4Tier1Feature2",
      "service4Tier1Feature3",
    ],
  ...
  },
  {
    ...
    featureKeys: [
      "service4Tier2Feature1",
      "service4Tier2Feature2",
      "service4Tier2Feature3",
    ],
  ...
  },
  {
    ...
    featureKeys: [
      "service4Tier3Feature1",
      "service4Tier3Feature2",
      "service4Tier3Feature3",
    ],
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {TIERS.map((tier) => (
            <Card
              ...
              className={
                tier.featured ? "ring-brand relative ring-2" : "relative"
              }
            >
              {tier.badgeKey && (
                <Badge
