...
const USER_AVATAR = "https://picsum.photos/seed/shell7-user/64/64";
      ...
      {CHANNELS.map((channel) => (
        <button
          ...
          className={cn(
            ...
            channel.name === "general" && "bg-muted text-fg font-medium",
          )}
        >
...
function MessageRow({
  ...
  return (
    <div className="flex gap-3">
      <Avatar
        size="sm"
        src={`https://picsum.photos/seed/${message.seed}/64/64`}
        alt={message.name}
