...
const CATEGORIES = [
  ...
  {
    id: "communication",
    labelKey: "settingsIntegrations3CategoryCommunication",
  },
...
export function IntegrationStatusTableSettingsIntegrations() {
  ...
  const statusMeta: Record<
    Status,
    { badge: "success" | "outline" | "warning"; labelKey: string }
  > = {
    connected: {
      badge: "success",
      labelKey: "settingsIntegrations3StatusConnected",
    },
    "not-connected": {
      badge: "outline",
      labelKey: "settingsIntegrations3StatusNotConnected",
    },
    attention: {
      badge: "warning",
      labelKey: "settingsIntegrations3StatusAttention",
    },
  };
          ...
          <CardHeader>
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex flex-col gap-1">
                ...
                <CardDescription>
                  {si.settingsIntegrations3Subheading}
                </CardDescription>
              </div>
          ...
          <CardContent>
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>
                    {si.settingsIntegrations3ColIntegration}
                  </TableHead>
