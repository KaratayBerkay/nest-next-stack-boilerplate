  ...
  return (
    <section className="w-full py-16 lg:py-24">
      <div className="mx-auto flex max-w-3xl flex-col gap-6 px-6 lg:px-8">
        ...
        <ul
          aria-label={si.settingsIntegrations5ListAria}
              ...
              <div className="flex flex-col gap-5 py-4">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <Switch
                    ...
                    aria-label={
                      si.settingsIntegrations5DrawerConnectSwitchLabel
                    }
                  />
                </div>
                ...
                <label className="flex flex-col gap-1.5 text-sm">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      updateSelected({ webhook: event.target.value })
                    }
                    placeholder={
                      si.settingsIntegrations5DrawerWebhookPlaceholder
                    }
                  />
                </label>
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <Switch
                    ...
                    onChange={(event) =>
                      updateSelected({ notify: event.target.checked })
                    }
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <Switch
                    ...
                    onChange={(event) =>
                      updateSelected({ autoSync: event.target.checked })
                    }
