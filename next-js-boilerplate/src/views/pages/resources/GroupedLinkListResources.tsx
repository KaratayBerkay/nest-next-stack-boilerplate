            ...
            <div key={group.id} className="flex flex-col gap-1">
              ...
              {group.items.map((item) => (
                ...
                >
                  ...
                  <IconArrowUpRight
                    size={15}
                    className="text-muted group-hover:text-brand mt-0.5 shrink-0 translate-x-0.5 -translate-y-0.5 opacity-0 transition-all duration-200 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:opacity-100 motion-reduce:transition-none"
                    aria-hidden="true"
                  />
                </Link>
              ))}
