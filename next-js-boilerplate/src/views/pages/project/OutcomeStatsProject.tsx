...
const METRICS: Metric[] = [
  {
    labelKey: "project7Metric1Label",
    valueKey: "project7Metric1Value",
    progress: 92,
  },
  {
    labelKey: "project7Metric2Label",
    valueKey: "project7Metric2Value",
    progress: 68,
  },
  {
    labelKey: "project7Metric3Label",
    valueKey: "project7Metric3Value",
    progress: 100,
  },
];
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="mt-2 flex flex-col gap-2">
              <span className="text-muted text-xs">{p.project7StackLabel}</span>
