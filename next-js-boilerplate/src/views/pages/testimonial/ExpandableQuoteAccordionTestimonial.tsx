...
const ITEMS: AccordionQuote[] = [
  {
    id: "item-1",
    nameKey: "testimonial9Item1Name",
    roleKey: "testimonial9Item1Role",
    teaserKey: "testimonial9Item1Teaser",
    quoteKey: "testimonial9Item1Quote",
  },
  {
    id: "item-2",
    nameKey: "testimonial9Item2Name",
    roleKey: "testimonial9Item2Role",
    teaserKey: "testimonial9Item2Teaser",
    quoteKey: "testimonial9Item2Quote",
  },
  {
    id: "item-3",
    nameKey: "testimonial9Item3Name",
    roleKey: "testimonial9Item3Role",
    teaserKey: "testimonial9Item3Teaser",
    quoteKey: "testimonial9Item3Quote",
  },
  {
    id: "item-4",
    nameKey: "testimonial9Item4Name",
    roleKey: "testimonial9Item4Role",
    teaserKey: "testimonial9Item4Teaser",
    quoteKey: "testimonial9Item4Quote",
  },
  {
    id: "item-5",
    nameKey: "testimonial9Item5Name",
    roleKey: "testimonial9Item5Role",
    teaserKey: "testimonial9Item5Teaser",
    quoteKey: "testimonial9Item5Quote",
  },
];
            ...
            {ITEMS.map((item) => (
              <AccordionItem key={item.id} value={item.id}>
                <AccordionTrigger className="group gap-4 px-5">
                  ...
                  <span className="text-muted hidden max-w-xs truncate text-sm italic group-data-[state=open]:hidden sm:block">
                    {tm[item.teaserKey]}
                  </span>
                  <IconChevronDown
                    size={18}
