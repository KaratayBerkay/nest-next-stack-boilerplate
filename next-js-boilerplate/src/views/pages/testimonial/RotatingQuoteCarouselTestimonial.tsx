...
const SLIDES: CarouselSlide[] = [
  {
    id: "slide-1",
    nameKey: "testimonial3Slide1Name",
    roleKey: "testimonial3Slide1Role",
    quoteKey: "testimonial3Slide1Quote",
  },
  {
    id: "slide-2",
    nameKey: "testimonial3Slide2Name",
    roleKey: "testimonial3Slide2Role",
    quoteKey: "testimonial3Slide2Quote",
  },
  {
    id: "slide-3",
    nameKey: "testimonial3Slide3Name",
    roleKey: "testimonial3Slide3Role",
    quoteKey: "testimonial3Slide3Quote",
  },
  {
    id: "slide-4",
    nameKey: "testimonial3Slide4Name",
    roleKey: "testimonial3Slide4Role",
    quoteKey: "testimonial3Slide4Quote",
  },
  {
    id: "slide-5",
    nameKey: "testimonial3Slide5Name",
    roleKey: "testimonial3Slide5Role",
    quoteKey: "testimonial3Slide5Quote",
  },
];
        ...
        <div className="border-border bg-surface relative mt-10 rounded-2xl border p-8 lg:p-12">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <Avatar
                fallback={initials(tm[active.nameKey])}
                size="md"
                variant="brand"
              />
        ...
        <div className="mt-6 flex items-center justify-center gap-4">
          ...
          {!reducedMotion && (
            <IconButton
              ...
              label={
                pausedByUser
                  ? tm.testimonial3PlayAria
                  : tm.testimonial3PauseAria
              }
              variant="ghost"
              size="icon-sm"
