    ...
    <section className="w-full py-16 lg:py-24">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="mx-auto flex max-w-xl flex-col items-center gap-3 text-center">
          ...
          <p className="text-muted text-sm leading-relaxed">{lg.logos7Intro}</p>
        </div>
        <ul
        ...
        >
          {BRANDS.map((brand) => (
            <li key={brand.id}>
              <div className="border-border hover:border-brand flex flex-col items-center gap-3 rounded-xl border p-5 text-center transition-all duration-200 hover:shadow-md">
                <brand.icon size={26} aria-hidden="true" className="text-fg" />
