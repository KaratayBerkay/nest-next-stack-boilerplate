...
function BlogCard({ post, t, index }: BlogAnimatedCardProps) {
  return (
    <article
      className="animate-fade-in-up group flex flex-col gap-4"
  ...
  return (
    <section className="w-full py-16 lg:py-24">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 lg:px-8">
        <div className="animate-fade-in-up flex max-w-2xl flex-col gap-4">
          <Typography
            variant="h2"
        ...
        <article className="animate-fade-in-up group flex flex-col gap-5">
          <a href={LINK_URL} className="block">
            <AspectRatio
              ratio={21 / 9}
            ...
            >
              <Image
                src={`https://picsum.photos/seed/${FEATURED_POST.seed}/1680/720`}
