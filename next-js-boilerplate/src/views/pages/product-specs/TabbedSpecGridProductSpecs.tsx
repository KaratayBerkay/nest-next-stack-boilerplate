...
const TABS: SpecTab[] = [
  {
    ...
    rows: [
      {
        labelKey: "productSpecs2DispScreenLabel",
        valueKey: "productSpecs2DispScreenValue",
      },
      {
        labelKey: "productSpecs2DispResolutionLabel",
        valueKey: "productSpecs2DispResolutionValue",
      },
      {
        labelKey: "productSpecs2DispProtectionLabel",
        valueKey: "productSpecs2DispProtectionValue",
      },
      {
        labelKey: "productSpecs2DispBodyLabel",
        valueKey: "productSpecs2DispBodyValue",
      },
    ],
  },
  {
    ...
    rows: [
      {
        labelKey: "productSpecs2CamRearLabel",
        valueKey: "productSpecs2CamRearValue",
      },
      {
        labelKey: "productSpecs2CamFrontLabel",
        valueKey: "productSpecs2CamFrontValue",
      },
      {
        labelKey: "productSpecs2CamZoomLabel",
        valueKey: "productSpecs2CamZoomValue",
      },
      {
        labelKey: "productSpecs2CamVideoLabel",
        valueKey: "productSpecs2CamVideoValue",
      },
    ],
  },
  {
    ...
    rows: [
      {
        labelKey: "productSpecs2PerfChipsetLabel",
        valueKey: "productSpecs2PerfChipsetValue",
      },
      {
        labelKey: "productSpecs2PerfRamLabel",
        valueKey: "productSpecs2PerfRamValue",
      },
      {
        labelKey: "productSpecs2PerfStorageLabel",
        valueKey: "productSpecs2PerfStorageValue",
      },
      {
        labelKey: "productSpecs2PerfNeuralLabel",
        valueKey: "productSpecs2PerfNeuralValue",
      },
    ],
  },
  {
    ...
    rows: [
      {
        labelKey: "productSpecs2BattCapacityLabel",
        valueKey: "productSpecs2BattCapacityValue",
      },
      {
        labelKey: "productSpecs2BattChargingLabel",
        valueKey: "productSpecs2BattChargingValue",
      },
      {
        labelKey: "productSpecs2BattNetworkLabel",
        valueKey: "productSpecs2BattNetworkValue",
      },
      {
        labelKey: "productSpecs2BattPortLabel",
        valueKey: "productSpecs2BattPortValue",
      },
    ],
  },
];
