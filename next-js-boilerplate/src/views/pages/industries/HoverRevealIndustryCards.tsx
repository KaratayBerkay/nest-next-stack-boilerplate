                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <IconArrowUpRight
                      size={18}
                      aria-hidden="true"
                      className="text-muted group-hover:text-brand group-focus-within:text-brand transition-all group-focus-within:translate-x-0.5 group-focus-within:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:-translate-y-0.5"
                    />
                  </div>
                  <h3 className="text-fg mt-5 text-lg font-semibold">
                    {i[industry.titleKey]}
                  </h3>
                  <div className="max-h-0 overflow-hidden opacity-0 transition-all duration-300 ease-out group-focus-within:mt-3 group-focus-within:max-h-28 group-focus-within:opacity-100 group-hover:mt-3 group-hover:max-h-28 group-hover:opacity-100">
