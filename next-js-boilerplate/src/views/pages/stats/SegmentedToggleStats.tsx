...
const SEGMENT_STATS: Record<Segment, SegmentStat[]> = {
  ...
  quarter: [
    {
      valueKey: "stats8QuarterStat1Value",
      labelKey: "stats8QuarterStat1Label",
    },
    {
      valueKey: "stats8QuarterStat2Value",
      labelKey: "stats8QuarterStat2Label",
    },
    {
      valueKey: "stats8QuarterStat3Value",
      labelKey: "stats8QuarterStat3Label",
    },
  ],
  year: [
  ...
  allTime: [
    {
      valueKey: "stats8AllTimeStat1Value",
      labelKey: "stats8AllTimeStat1Label",
    },
    {
      valueKey: "stats8AllTimeStat2Value",
      labelKey: "stats8AllTimeStat2Label",
    },
    {
      valueKey: "stats8AllTimeStat3Value",
      labelKey: "stats8AllTimeStat3Label",
    },
  ],
};
