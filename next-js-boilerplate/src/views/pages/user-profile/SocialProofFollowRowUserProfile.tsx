...
const MUTUALS: MutualEntry[] = [
  {
    id: "mutual-1",
    variant: "brand",
    fallbackKey: "userProfile6Mutual1AvatarFallback",
    nameKey: "userProfile6Mutual1Name",
  },
  {
    id: "mutual-2",
    variant: "info",
    fallbackKey: "userProfile6Mutual2AvatarFallback",
    nameKey: "userProfile6Mutual2Name",
  },
  {
    id: "mutual-3",
    variant: "success",
    fallbackKey: "userProfile6Mutual3AvatarFallback",
    nameKey: "userProfile6Mutual3Name",
  },
];
...
const MUTUALS_EXTRA: MutualEntry[] = [
  {
    id: "mutual-extra-1",
    variant: "warning",
    fallbackKey: "userProfile6MutualExtra1AvatarFallback",
    nameKey: "userProfile6MutualExtra1Name",
  },
  {
    id: "mutual-extra-2",
    variant: "default",
    fallbackKey: "userProfile6MutualExtra2AvatarFallback",
    nameKey: "userProfile6MutualExtra2Name",
  },
];
    ...
    <section className="w-full py-16 lg:py-24">
      <div className="mx-auto max-w-2xl px-6 lg:px-8">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-fg max-w-md leading-relaxed">
            {up.userProfile6Bio}
          </p>
          <Button
        ...
        <div className="border-border bg-surface rounded-xl border p-5">
          ...
          >
            {expanded
              ? up.userProfile6ShowLessButton
              : up.userProfile6ShowMoreButton}
            {expanded ? (
