        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {members.map((member) => {
            ...
            const currentRoleLabelKey =
              ROLE_MENU.find((option) => option.value === member.role)
                ?.labelKey ?? "settingsMembers2RoleViewer";
                  ...
                  <div className="flex items-center justify-between gap-2">
                    {member.isOwner ? (
                      ...
                      <Badge variant="outline">
                        {sm.settingsMembers2StatusPending}
                      </Badge>
                    ) : (
                      <Badge variant="secondary">
                        {sm[currentRoleLabelKey]}
                      </Badge>
                    )}
