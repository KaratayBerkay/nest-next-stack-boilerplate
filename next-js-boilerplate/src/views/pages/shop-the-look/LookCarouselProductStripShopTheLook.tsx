...
const LOOKS: CarouselLook[] = [
  {
    ...
    products: [
      {
        id: "w1",
        nameKey: "shopTheLook6Look1Product1Name",
        price: 64,
        seed: "stl6-look1-p1",
      },
      {
        id: "w2",
        nameKey: "shopTheLook6Look1Product2Name",
        price: 88,
        seed: "stl6-look1-p2",
      },
      {
        id: "w3",
        nameKey: "shopTheLook6Look1Product3Name",
        price: 122,
        seed: "stl6-look1-p3",
      },
    ],
  },
  {
    ...
    products: [
      {
        id: "o1",
        nameKey: "shopTheLook6Look2Product1Name",
        price: 96,
        seed: "stl6-look2-p1",
      },
      {
        id: "o2",
        nameKey: "shopTheLook6Look2Product2Name",
        price: 148,
        seed: "stl6-look2-p2",
      },
      {
        id: "o3",
        nameKey: "shopTheLook6Look2Product3Name",
        price: 58,
        seed: "stl6-look2-p3",
      },
    ],
  },
  {
    ...
    products: [
      {
        id: "e1",
        nameKey: "shopTheLook6Look3Product1Name",
        price: 176,
        seed: "stl6-look3-p1",
      },
      {
        id: "e2",
        nameKey: "shopTheLook6Look3Product2Name",
        price: 84,
        seed: "stl6-look3-p2",
      },
      {
        id: "e3",
        nameKey: "shopTheLook6Look3Product3Name",
        price: 132,
        seed: "stl6-look3-p3",
      },
    ],
