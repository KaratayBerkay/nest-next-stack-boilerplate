            ...
            <Card>
              <CardContent className="flex flex-col gap-5 pt-6">
                ...
                <div className="flex items-center gap-4">
                  <Avatar
                    src={
                      hasLogo ? "/img/placeholders/ph-1x1-3.webp" : undefined
                    }
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="flex flex-col gap-1.5">
                    <Label htmlFor="cc1-name">
                      {c.crudCompanies1NameLabel}
                    </Label>
                    <Input
                      id="cc1-name"
                      value={form.name}
            ...
            <Card>
              <CardContent className="flex flex-col gap-5 pt-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <Label htmlFor="cc1-city">
                      {c.crudCompanies1CityLabel}
                    </Label>
                    <Input
                      id="cc1-city"
                      value={form.city}
          ...
          <div className="flex flex-col gap-6">
            <Card>
              <CardContent className="flex flex-col gap-5 pt-6">
                ...
                <div className="flex flex-col gap-1.5">
                  <Label htmlFor="cc1-notes">
                    {c.crudCompanies1NotesLabel}
                  </Label>
                  <Textarea
                    id="cc1-notes"
                    value={form.notes}
