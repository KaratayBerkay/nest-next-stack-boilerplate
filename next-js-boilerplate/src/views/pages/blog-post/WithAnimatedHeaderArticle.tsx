...
const AUTHOR_AVATAR_URL =
  "https://picsum.photos/seed/blogpost7-author/128/128" as const;
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 lg:px-8">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            <span
              className="animate-fade-in-up text-brand text-xs font-semibold tracking-wider uppercase"
            ...
            <Typography
              variant="h2"
              className="animate-fade-in-up text-4xl font-medium tracking-tighter md:text-5xl"
            ...
            <Typography
              variant="bodyLarge"
              className="animate-fade-in-up text-muted"
            ...
            <span
              className="animate-fade-in-up text-muted flex items-center gap-1.5 text-sm"
          ...
          <div className="animate-fade-in-up" style={staggerDelay(6)}>
            ...
            >
              <Image
                src="https://picsum.photos/seed/blogpost7-hero/1200/900"
