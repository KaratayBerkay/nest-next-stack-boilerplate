...
export const AddressGroup = withFieldGroup({
  ...
  render: function AddressGroupInner({ group }) {
    ...
    const schemas = useMemo(
      () => createCheckoutFieldSchemas(t.checkoutTab),
      [t],
    );
    ...
    const addressOptions = useMemo(
      () => [
        { value: "us", label: t.checkoutTab.countryUs },
        { value: "ca", label: t.checkoutTab.countryCa },
        { value: "gb", label: t.checkoutTab.countryGb },
        { value: "tr", label: t.checkoutTab.countryTr },
      ],
      [t],
    );
    return (
      <div className="flex flex-col gap-3">
        <div className="grid grid-cols-2 gap-3">
          <group.AppField name="street" validators={{ onBlur: schemas.street }}>
            {(field) => (
              <field.TextField label={t.checkoutTab.street} required />
            )}
          </group.AppField>
        ...
        <div className="grid grid-cols-2 gap-3">
          <group.AppField
            name="province"
            validators={{ onBlur: schemas.province }}
          >
            {(field) => (
              <field.TextField label={t.checkoutTab.province} required />
            )}
          </group.AppField>
          <group.AppField
            name="postalCode"
          ...
          >
            {(field) => (
              <field.TextField
                label={t.checkoutTab.postalCode}
                hint={t.checkoutTab.postalCodeHint}
                required
              />
            )}
          </group.AppField>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            {(field) => (
              <field.TextField
                label={t.checkoutTab.phone}
                hint={t.checkoutTab.phoneHint}
              />
            )}
          </group.AppField>
        </div>
