...
import { groupAttachmentsByDay } from "@/views/messages/AttachmentGallerySheet-utils";
...
export function AttachmentGallerySheet({
  ...
  const {
    ...
    ...conversationAttachmentsQueryOptions(peerId, {
      search,
      from: dateRange?.from,
      to: dateRange?.to,
    }),
  ...
  // Pages are already newest-first (see conversationAttachmentsQueryOptions)
