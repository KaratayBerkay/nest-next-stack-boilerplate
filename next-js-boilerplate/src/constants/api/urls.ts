export const STRIPE_CREATE_SETUP_INTENT_URL = "/api/billing/create-setup-intent" as const;
...
export const PROFILE_USERNAME_AVAILABLE_PREFIX = "/api/profile/username-available" as const;
...
export const MESSAGES_FRIENDS_REQUEST_PREFIX = "/api/messages/friends/request/" as const;
export const MESSAGES_FRIENDS_ACCEPT_PREFIX = "/api/messages/friends/accept/" as const;
export const MESSAGES_FRIENDS_DECLINE_PREFIX = "/api/messages/friends/decline/" as const;
export const MESSAGES_CONVERSATIONS_PREFIX = "/api/messages/conversations/" as const;
...
export const MESSAGES_CONVERSATIONS_URL = "/api/messages/conversations" as const;
export const MESSAGES_CONVERSATION_MESSAGES_PREFIX = "/api/messages/conversations/" as const;
...
export const NOTIFICATIONS_UNREAD_COUNT_URL = "/api/notifications/unread-count" as const;
