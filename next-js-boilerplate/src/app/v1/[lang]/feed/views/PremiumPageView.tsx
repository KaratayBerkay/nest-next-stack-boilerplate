...
function FeedList({ search, currentUserId }: { search: string; currentUserId?: string }) {
      ...
      {posts.map((post) => (
        <div key={post.id} className="relative">
          {post.author.id === currentUserId && (
            <span className="absolute -top-1 -right-1 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-brand text-white">
