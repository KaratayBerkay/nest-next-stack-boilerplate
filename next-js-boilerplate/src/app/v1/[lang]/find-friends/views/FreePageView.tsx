                ...
                return (
                  ...
                  >
                    <Avatar
                      ...
                      className="h-10 w-10 shrink-0 bg-brand text-xs text-white"
                    />
                    <span className="flex-1 text-sm font-medium">{u.name}</span>
                    {isPending ? (
                      <span className="rounded bg-surface px-3 py-1 text-xs text-muted">
                        {t.pending}
                      </span>
                    ) : (
                      <button
                        ...
                        className="rounded-lg bg-brand px-3 py-1 text-sm text-white hover:opacity-80"
                      >
                        {t.addFriend}
                      </button>
                    )}
                ...
                {r.direction === "incoming" ? (
                  <>
                    ...
                    <button
                      ...
                      className="rounded bg-surface px-3 py-1 text-xs hover:bg-surface-hover"
                    >
                      {t.decline}
                    </button>
                  </>
